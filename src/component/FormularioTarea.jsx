...
const FormularioTarea = () =>{
  ...
  const listaLocalS=JSON.parse(localStorage.getItem("tareasKey"))||[];
  const [listTarea, setListTarea] = useState(listaLocalS);

  useEffect(()=>{
    localStorage.setItem("tareasKey", JSON.stringify(listTarea))
   //codigo que vamos a ejecutar en un momento puntual del ciclo de vida
    }, [listTarea])
    //en los corchetes agrego el estado que quiero seguir y que se ejecute nuestro codigo)
